...
class Pyhabot():
    ...
    async def subScraperTask(self, id_, news):
        print('mostfut', id_)
    ...
    async def scrapeAdsTask(self):
        while True:
            ...
            print(f"Rotating is: {rotating}")
            for id_ in self.viewers["list"]:
                await self.subScraperTask(id_, news)
                await asyncio.sleep(rotating)
